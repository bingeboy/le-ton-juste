...
WORST_CASE_PK_MAX      = 6.0            # v_out peak at Dwell-max/Mix-CW; U3 must not rail.
                                        ...
                                        # allows ±10% margin. Cannot trip unless U3 acquires
                                        # unexpected gain or supply fails.
...
MIX_CCW_WET_ARRIVAL_WINDOW = (0.20, 0.65) # mix_ccw_wet_ratio = V(mix_wet)/V(hpf_out);
                                        ...
                                        # bottom at center wiper, CCW load). At center wiper
                                        # the ratio is ~0.40. A broken RV3 wiper, open
...
MIX_CW_VOUT_PK_MIN  = 0.20              # V pk; wet path at full-CW. Baseline sim (Mix-noon)
