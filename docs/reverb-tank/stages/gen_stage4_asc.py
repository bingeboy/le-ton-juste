...
OPA_PARAMS_NET = ("level2 level2 Avol=1Meg GBW=8Meg Slew=20Meg Ilimit=25m "
                  "Rail=0 Rinc=1T Ilimit=25m Rail=0 Vos=0 En=0 Enk=0 In=0 "
                  "Ink=0 Rin=500Meg ;§pnba In+)In-)V+)V-)OUT")
...
def build(active_analysis="op"):
    ...
    b.diode("TVS1a", "BZX84C15L", 64, 400, "vin", "tvs_mid")
    b.diode("TVS1b", "BZX84C15L", 64, 528, "0", "tvs_mid")
    ...
    if active_analysis == "op":
        ...
        b.directive(".meas OP tvs_a_i FIND I(TVS1a)")
        b.directive(".meas OP tvs_b_i FIND I(TVS1b)")
